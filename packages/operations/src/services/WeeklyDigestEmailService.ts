import type { NextGameResponseDto, TopPlayerResponseDto } from "@lufa/contracts";
...
export interface DigestRecipientPort {
  findAll(filters?: Record<string, unknown>): Promise<Array<{ email: string }>>;
}

export interface DigestEmailPort {
...
export class WeeklyDigestEmailService {
  constructor(
    private readonly emailService: DigestEmailPort,
    private readonly dashboardService: DashboardService,
    private readonly userRepo: DigestRecipientPort,
  ) {}
