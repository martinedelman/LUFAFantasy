...
import { EmergencyContact, Player, PlayerPosition } from "@lufa/sports/entities/Player";
import { Team } from "@lufa/sports/entities/Team";
import { PlayerService } from "@lufa/sports/services/PlayerService";
import { TeamService } from "@lufa/sports/services/TeamService";
import {
  getConfiguredAppUrl,
  PreApprovedPlayerNotificationService,
} from "@lufa/integrations/services/PreApprovedPlayerNotificationService";
...
export interface PlayerImportRepositoryPort {
...
export class PlayerImportService {
  constructor(
    ...
    private readonly notificationService: PreApprovedPlayerNotificationService,
    private readonly auxiliaryRepo: PlayerImportRepositoryPort,
  ) {}
