...
export type PaginatedResponse<T> = import("./Responses").PaginatedResponseDto<T>;

export type ApiResponse<T> = import("./Responses").ApiResponseDto<T>;

// API Response types for populated data

export type TeamApiResponse = import("./Responses").TeamSummaryResponseDto;

export type PlayerApiResponse = import("./Responses").PlayerSummaryResponseDto;

export type GameApiResponse = import("./Responses").GameLiveResponseDto;
