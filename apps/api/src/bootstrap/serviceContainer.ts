...
import { PrismaFantasyIdentityRepository } from "@lufa/database/repositories/fantasy";
import { FantasyIdentityService } from "@lufa/fantasy-core";
...
const fantasyIdentityService = new FantasyIdentityService(new PrismaFantasyIdentityRepository(), {
  async sendPasswordReset({ to, name, code, expiresInMinutes }) {
    ...
    await emailService.send({
      to,
      subject: "Tu código para volver a Huddle",
